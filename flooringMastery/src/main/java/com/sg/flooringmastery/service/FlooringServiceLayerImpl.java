...
public class FlooringServiceLayerImpl implements FlooringServiceLayer {
    ...
    @Override
    public Order validateAndCalculateTempOrder(Order tempOrder) throws FlooringDataValidationException.FlooringPersistenceException, FlooringDataValidationException {
